...
class ControllerAdministrador{
    ...
    public static function ctrSearchEmail($searhEmail){
        return ModelAdministrador::mdlSearchEmail($searhEmail);
    }
    public static function ctrChangePassword($idChange,$nueva){
        return ModelAdministrador::mdlChangePassword($idChange,$nueva);
    }
}
?>